...
void    RST_1_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the RST_1_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(RST_1__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in RST_1_SetInterruptMode() function.
     *  @{
     */
        #define RST_1_INTR_NONE      (uint16)(0x0000u)
        #define RST_1_INTR_RISING    (uint16)(0x0001u)
        #define RST_1_INTR_FALLING   (uint16)(0x0002u)
        #define RST_1_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define RST_1_INTR_MASK      (0x01u) 
#endif /* (RST_1__INTSTAT) */
...
/* SIO registers */
#if defined(RST_1__SIO_CFG)
    #define RST_1_SIO_HYST_EN        (* (reg8 *) RST_1__SIO_HYST_EN)
    #define RST_1_SIO_REG_HIFREQ     (* (reg8 *) RST_1__SIO_REG_HIFREQ)
    #define RST_1_SIO_CFG            (* (reg8 *) RST_1__SIO_CFG)
    #define RST_1_SIO_DIFF           (* (reg8 *) RST_1__SIO_DIFF)
#endif /* (RST_1__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define RST_1_0_INTTYPE_REG 		(* (reg8 *) RST_1__0__INTTYPE)
#endif /* (RST_1__INTSTAT) */
